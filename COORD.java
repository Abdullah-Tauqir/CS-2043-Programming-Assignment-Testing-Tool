...
public class COORD {
    ...
    public boolean[] ExecuteSuiteReturnResults(String suiteName) {
    TestSuite suite = ListOfTestSuites.searchByName(suiteName);
    if (suite == null) {
        System.out.println("Suite not found.");
        return null;
    }

    ExecuteTestSuite executor = new ExecuteTestSuite();
    return executor.ExecuteTestSuite(suite);  
}
